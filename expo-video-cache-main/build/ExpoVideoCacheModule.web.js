...
class ExpoVideoCacheModule extends NativeModule {
     ...
     */
    async startServer(port, maxCacheSize, headOnlyCache) {
        console.warn("ExpoVideoCache: Local proxy server is not supported on Web. Videos will stream directly.");
    }
    /**
     ...
     */
    async clearCache() {
        console.warn("ExpoVideoCache: programmatic cache clearing is not supported by browser APIs.");
    }
}
export default registerWebModule(ExpoVideoCacheModule, "ExpoVideoCache");
//# sourceMappingURL=ExpoVideoCacheModule.web.js.map