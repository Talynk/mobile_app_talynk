...
exports.addComment = async (req, res) => {
    try {
        ...
        try {
            const { recordEngagement } = require('../services/recommendation/affinityService');
            await recordEngagement(resolvedUser.id, postId, 'comment');
        } catch (affinityErr) {
            console.warn('[commentController] affinity recordEngagement:', affinityErr.message);
        }
